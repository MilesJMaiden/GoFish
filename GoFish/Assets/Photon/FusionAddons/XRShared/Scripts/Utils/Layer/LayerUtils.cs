...
namespace Fusion.XR.Shared.Utils
{
    ...
    {
        // Apply layer named layerToApplyName to gameObject (and potentially to its children if applyLayerToChildren is true)
        ...
        // Apply layer layer to gameObject (and potentially to its children if applyLayerToChildren is true)
        ...
        // Apply layer layer to gameObject and to children of type T (and potentially to its children if applyLayerToChildren is true)
